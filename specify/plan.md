...
| **M4** | **The Agentic Engine** | Sovereign API abstraction (SSE) + MCP Client + Reasoning Loop logic. **Tasks:** `specify/tasks/004_milestone_4.md`. **Manual test timing:** `specify/testing-checkpoints.md`. |
